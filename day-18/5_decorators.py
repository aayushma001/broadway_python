...
# If a function takes another function as argument, then such a function is called higher order
# function, map(), reduce(), filter(), sorted(), all the decorators are higher order function.
